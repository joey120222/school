<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AboutUs.aspx.cs" Inherits="SchoolInfo.Admin.AboutUs" %>
            ...
            <%
                for (int i = 0; i < dtDataList.Rows.Count; i++)
                {
                    ...
                    <tr>
                        ...
                        <td><%= dtDataList.Rows[i]["student_phone"]%></td>
                        <td><%= dtDataList.Rows[i]["student_email"]%></td>
                        <td><%= Convert.ToDateTime(dtDataList.Rows[i]["aboutus_date"]).ToString("yyyy-MM-dd HH:mm:ss")%></td>
                        <td><%= dtDataList.Rows[i]["aboutus_content"]%></td>
                    </tr>
                    <%
                }
            %>
