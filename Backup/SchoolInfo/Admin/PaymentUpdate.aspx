<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentUpdate.aspx.cs" Inherits="SchoolInfo.Admin.PaymentUpdate" %>
...
<body>
    <form id="form" runat="server">
        <div class="form-title">Payment Add</div>
        <div class="form-line">
            <div class="form-name">Payment Bank:</div>
            <asp:TextBox ID="txtBank" class="form-input" runat="server"></asp:TextBox>
        </div>
        <div class="form-line">
            <div class="form-name">Payment Name:</div>
            <asp:TextBox ID="txtName" class="form-input" runat="server"></asp:TextBox>
        </div>
        <div class="form-line">
            <div class="form-name">Payment Code:</div>
