...
{
    public partial class BenefitsAdd : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (SQLServerUtil.Handler("INSERT INTO tb_benefits(benefits_name,benefits_image,benefits_content)VALUES('" + name + "','" + fileName + "','" + content + "')"))
            {
