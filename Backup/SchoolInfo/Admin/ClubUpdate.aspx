<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClubUpdate.aspx.cs" Inherits="SchoolInfo.Admin.ClubUpdate" %>
...
<body>
    <form id="form" runat="server">
        <div class="form-title">Club Add</div>
        <div class="form-line">
            <div class="form-name">Club Name:</div>
            <asp:TextBox ID="txtName" class="form-input" runat="server"></asp:TextBox>
        </div>
        <div class="form-line">
            <div class="form-name">Club Image:</div>
            <asp:FileUpload ID="txtUpload" class="form-upload" runat="server" />
        </div>
        <div class="form-line">
            <div class="form-name">Club Content:</div>
