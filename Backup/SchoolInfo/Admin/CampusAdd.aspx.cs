...
{
    public partial class CampusAdd : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (SQLServerUtil.Handler("INSERT INTO tb_campus(campus_name,campus_image,campus_content)VALUES('" + name + "','" + fileName + "','" + content + "')"))
            {
