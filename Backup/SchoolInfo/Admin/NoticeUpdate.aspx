<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoticeUpdate.aspx.cs" Inherits="SchoolInfo.Admin.NoticeUpdate" %>
...
<body>
    <form id="form" runat="server">
        <div class="form-title">Notice Add</div>
        <div class="form-line">
            <div class="form-name">Notice Name:</div>
            <asp:TextBox ID="txtName" class="form-input" runat="server"></asp:TextBox>
        </div>
        <div class="form-line">
            <div class="form-name">Notice Content:</div>
