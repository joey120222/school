<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventUpdate.aspx.cs" Inherits="SchoolInfo.Admin.EventUpdate" %>
...
<body>
    <form id="form" runat="server">
        <div class="form-title">Event Add</div>
        <div class="form-line">
            <div class="form-name">Event Name:</div>
            <asp:TextBox ID="txtName" class="form-input" runat="server"></asp:TextBox>
        </div>
        <div class="form-line">
            <div class="form-name">Event Image:</div>
            <asp:FileUpload ID="txtUpload" class="form-upload" runat="server" />
        </div>
        <div class="form-line">
            <div class="form-name">Event Content:</div>
