<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Facibility.aspx.cs" Inherits="SchoolInfo.Admin.Facibility" %>
    ...
    <table class="table-list">
        <thead>
            <tr>
                ...
                <td>Start Date</td>
                <td>End Date</td>
                <td>Facibility Name</td>
                <td>Facibility Content</td>
            </tr>
        </thead>
        <tbody>
            <%
                for (int i = 0; i < dtDataList.Rows.Count; i++)
                {
                    ...
                    <tr>
                        ...
                        <td><%= dtDataList.Rows[i]["facibility_startdate"]%></td>
                        <td><%= dtDataList.Rows[i]["facibility_enddate"]%></td>
                        <td><%= dtDataList.Rows[i]["facibility_name"]%></td>
                        <td><%= dtDataList.Rows[i]["facibility_content"]%></td>
                    </tr>
                    <%
                }
            %>
