<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EduationUpdate.aspx.cs" Inherits="SchoolInfo.Admin.EduationUpdate" %>
...
<body>
    <form id="form" runat="server">
        <div class="form-title">Eduation Add</div>
        <div class="form-line">
            <div class="form-name">Eduation Name:</div>
            <asp:TextBox ID="txtName" class="form-input" runat="server"></asp:TextBox>
        </div>
        <div class="form-line">
            <div class="form-name">Eduation Image:</div>
            <asp:FileUpload ID="txtUpload" class="form-upload" runat="server" />
        </div>
        <div class="form-line">
            <div class="form-name">Eduation Content:</div>
