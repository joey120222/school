<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClubEventUpdate.aspx.cs" Inherits="SchoolInfo.Admin.ClubEventUpdate" %>
...
<body>
    <form id="form" runat="server">
        <div class="form-title">ClubEvent Add</div>
        <div class="form-line">
            <div class="form-name">ClubEvent Name:</div>
            <asp:TextBox ID="txtName" class="form-input" runat="server"></asp:TextBox>
        </div>
        <div class="form-line">
            <div class="form-name">ClubEvent Content:</div>
