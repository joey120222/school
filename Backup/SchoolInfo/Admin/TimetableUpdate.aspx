<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TimetableUpdate.aspx.cs" Inherits="SchoolInfo.Admin.TimetableUpdate" %>
...
<body>
    <form id="form" runat="server">
        <div class="form-title">Timetable Add</div>
        <div class="form-line">
            <div class="form-name">Timetable Name:</div>
            <asp:TextBox ID="txtName" class="form-input" runat="server"></asp:TextBox>
        </div>
        <div class="form-line">
            <div class="form-name">Timetable File:</div>
