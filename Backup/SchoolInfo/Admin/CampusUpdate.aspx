<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CampusUpdate.aspx.cs" Inherits="SchoolInfo.Admin.CampusUpdate" %>
...
<body>
    <form id="form" runat="server">
        <div class="form-title">Campus Add</div>
        <div class="form-line">
            <div class="form-name">Campus Name:</div>
            <asp:TextBox ID="txtName" class="form-input" runat="server"></asp:TextBox>
        </div>
        <div class="form-line">
            <div class="form-name">Campus Image:</div>
            <asp:FileUpload ID="txtUpload" class="form-upload" runat="server" />
        </div>
        <div class="form-line">
            <div class="form-name">Campus Content:</div>
